package com.plm.platform.gateway.common.handler;
 ...
 */
@Slf4j
public class PlatformGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public PlatformGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
