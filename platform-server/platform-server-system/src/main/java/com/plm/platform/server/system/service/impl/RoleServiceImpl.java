...
import com.plm.platform.server.system.mapper.RoleMapper;
import com.plm.platform.server.system.service.IRoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    public IPage<Role> findRoles(Role role, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", PlatformConstant.ORDER_DESC, false);
