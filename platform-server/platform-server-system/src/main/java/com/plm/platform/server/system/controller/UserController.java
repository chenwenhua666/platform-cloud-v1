...
public class UserController {
    ...
    public PlatformResponse index() {
        ...
        param.setUsername(PlatformUtil.getCurrentUsername());
        ...
        return new PlatformResponse().data(data);
    }
    ...
    public PlatformResponse userList(QueryRequest queryRequest, SystemUser user) {
        Map<String, Object> dataTable = PlatformUtil.getDataTable(userService.findUserDetailList(user, queryRequest));
    ...
    public void updateProfile(@Valid SystemUser user) throws PlatformException {
