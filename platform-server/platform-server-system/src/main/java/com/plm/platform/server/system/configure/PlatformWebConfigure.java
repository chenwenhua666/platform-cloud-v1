...
import com.plm.platform.server.system.properties.PlatformSwaggerProperties;
...
public class PlatformWebConfigure {
    ...
    public ThreadPoolTaskExecutor asyncThreadPoolTaskExecutor() {
        ...
        executor.setThreadNamePrefix("Platform-System-Async-Thread");
    ...
    public Docket swaggerApi() {
        PlatformSwaggerProperties swagger = properties.getSwagger();
    ...
    private ApiInfo apiInfo(PlatformSwaggerProperties swagger) {
        return new ApiInfo(
                swagger.getTitle(),
    ...
    private SecurityScheme securityScheme(PlatformSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(PlatformSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(PlatformSwaggerProperties swagger) {
