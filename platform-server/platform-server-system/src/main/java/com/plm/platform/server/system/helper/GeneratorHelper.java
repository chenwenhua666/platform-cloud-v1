package com.plm.platform.server.system.helper;

import com.plm.platform.common.annotation.Helper;
...
import com.plm.platform.server.system.entity.FieldType;
import com.plm.platform.server.system.utils.AddressUtil;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(PlatformUtil.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        JSONObject data = toJsonObject(configure);
        columns.forEach(c -> c.setField(PlatformUtil.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        data.put("columns", columns);
