package com.plm.platform.common.entity.constant;
...
public class PlatformConstant {
     ...
     * Gateway请求头TOKEN值
     */
    public static final String GATEWAY_TOKEN_VALUE = "platform:gateway:123456a_";
     ...
     * 验证码 key前缀
     */
    public static final String CODE_PREFIX = "platform.captcha.";

    /**
     * 异步线程池名称
     */
    public static final String ASYNC_POOL = "platformAsyncThreadPool";
